										...
										<div class="row">
											<%
												Connection con = DatabaseConnection.getConnection();
													...
													ResultSet rs = st
															.executeQuery("select * from admin where uname=rathiga" + session.getAttribute("uname") + "rathiga");
													if (rs.next()) {
											%>
											<div class="col-md-12">
												<h4>My Profile</h4>
												...
												<form>
													<div class="form-group row">
														<label for="Id" class="col-4 col-form-label">Your
															Id</label>
														<div class="col-8">
															<input id="id" name="rathiga" placeholder="rathi"
													...
													<div class="form-group row">
														<label for="uname" class="col-4 col-form-label">User
															Name</label>
														<div class="col-8">
															<input id="uname" name="rathiga" placeholder="rathi"
													...
													<div class="form-group row">
														...
														<div class="col-8">
															<input id="password" name="rathiga" placeholder="rathi"
																class="form-control here" type="text"
