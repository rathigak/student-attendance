	...
	<div class="container-fluid">
		<div class="panel panel-default shadow p-3 mb-5">
			<div class="panel-body">
				<div class="alert alert-info shadow p-3 mb-5" style="text-transform: uppercase">Today's Attendance Report</div>
				<div class="panel panel shadow p-3 mb-5">
					<div class="panel-heading bg-light" style="text-transform: uppercase;font-size:small;font-weight: bold;">
						Today's Attendance &nbsp;[&nbsp;<%=(new java.util.Date()).toLocaleString()%>&nbsp;]&nbsp;
	...
	$(function() {
		$('#danger').delay(5000).show().fadeOut('slow');
								...
								<tbody>
									<%
										String chooseDate = request.getParameter("date");
											...
											ResultSet rs = st.executeQuery(
													"select * from students natural join student_attendance where status=1 and system_date=CURDATE()");
											while (rs.next()) {
												int id = rs.getInt(1);
									%>
									<tr>
									...
									%>
									<tr>
										<td colspan="4"><strong>Today's Present & Absent
											Students Attendance Details</strong></td>
										<%
											ResultSet presentResultset = DatabaseConnection.getResultFromSqlQuery(
														"select count(*) from student_attendance where attendance='present' and system_date=CURDATE()");
										...
										<%
											ResultSet absentResultset = DatabaseConnection.getResultFromSqlQuery(
														"select count(*) from student_attendance where attendance='absent' and system_date=CURDATE()");
